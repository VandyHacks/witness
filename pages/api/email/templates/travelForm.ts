...
export default (user: UserData): SendEmailRequest => ({
	Destination: {
	...
	Message: {
		Body: {
			Html: {
				...
				<head>
					<title> You've indicated you'd like to apply for a travel reimbursement! </title>
					<!--[if !mso]><!-- -->
																	...
																	<table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
																		<tr>
																			<td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
																				<div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:20px;font-weight:bold;line-height:24px;text-align:left;color:#212b35;"> Just one more step! </div>
																			</td>
																		</tr>
																		<tr>
																			<td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
																		...
																		<tr>
																			<td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
																				<div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">
																					Thanks for taking the time to complete your application! We’re so excited that you’re interested in being a part of <b>VandyHacks X: Neon Edition</b>.
																				</div>
																			</td>
																		</tr>
																		<tr>
																			<td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
																				<div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">
                                                                                You indicated that you'd like to apply for travel reimbursements! Here is the form to apply: <a href='http://vhl.ink/travelreimbursement'> http://vhl.ink/travelreimbursement </a>
																				</div>
																			</td>
																		</tr>
                                                                        <tr>
                                                                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                                                <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">
                                                                                To be considered for travel reimbursements you must complete this form by <b>September 30, 2022 at 11:59 PM US Central Time</b>. There will be no exceptions to this deadline, so please make sure you plan accordingly.
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                                                <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">
                                                                                Please note that submitting a Hacker application on the VandyHacks portal does not guarantee that one will be given travel reimbursement. You will be notified if you have received a reimbursement.
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                                            <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">
                                                                            As always if you have any questions, please reach out to us at <a href='info@vandyhacks.org'> info@vandyhacks.org </a>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
																		<tr>
